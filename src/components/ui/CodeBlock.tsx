  ...
  return (
    <>
      <button
        ...
        className="md:hidden flex text-lg items-center justify-center gap-2 w-full font-semibold py-[0.75rem] p-[0.5rem] mb-2 rounded-md hover:bg-zinc-200 transition-colors"
